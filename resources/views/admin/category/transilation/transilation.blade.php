        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Category Translation</h4>
                            <a class="btn btn-block btn-primary"
                                style="max-width:150px; float:right; display:inline-block;"
                                href="{{ route('categories.translations.create', [$categoryId]) }}">Add Category Data
                            </a>
                                ...
                                <table id="" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('categories.translations.edit', [$categoryId, $translation->id]) }}" class="btn  btn-primary">Edit</a>
                                                <form action="{{ route('categories.translations.destroy', [$categoryId, $translation->id]) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
