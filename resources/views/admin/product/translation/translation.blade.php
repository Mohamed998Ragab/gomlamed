        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Product Translation</h4>
                            <a class="btn btn-block btn-primary"
                                style="max-width:150px; float:right; display:inline-block;"
                                href="{{ route('products.translations.create', [$productId]) }}">Add Product Data
                            </a>
                            <br> <br>
                            <br>
                            <a class="btn btn-block btn-primary"
                                ...
                                <table id="" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('products.translations.edit', [$productId, $translation->id]) }}" class="btn  btn-primary">Edit</a>
                                                <form action="{{ route('products.translations.destroy', [$productId, $translation->id]) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
