        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Slider Translation</h4>
                            <a class="btn btn-block btn-primary"
                                style="max-width:150px; float:right; display:inline-block;"
                                href="{{ route('sliders.translations.create', [$sliderId]) }}">Add Slider Data
                            </a>
                            <br> <br>
                            <br>
                            <a class="btn btn-block btn-primary"
                            style="max-width:100px; float:right; display:inline-block;"
                            href="{{ url('admin/slider') }}">Back
                            </a>
                                ...
                                <table id="" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $translation->second_title }}</td>
                                            <td>{{ $translation->description }}</td>

                                            <td>
                                                <a href="{{ route('sliders.translations.edit', [$sliderId, $translation->id]) }}" class="btn  btn-primary">Edit</a>
                                                <form action="{{ route('sliders.translations.destroy', [$sliderId, $translation->id]) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
