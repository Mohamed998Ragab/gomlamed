        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">First Banner Translation</h4>
                            <a class="btn btn-block btn-primary"
                                style="max-width:150px; float:right; display:inline-block;"
                                href="{{ route('firstBanners.translations.create', [$firstBannerId]) }}">Add Banner Data
                            </a>
                            <br> <br>
                            <br>
                            <a class="btn btn-block btn-primary"
                            style="max-width:100px; float:right; display:inline-block;"
                            href="{{ url('admin/firstBanner') }}">Back
                            </a>
                                ...
                                <table id="" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('firstBanners.translations.edit', [$firstBannerId, $translation->id]) }}" class="btn  btn-primary">Edit</a>
                                                <form action="{{ route('firstBanners.translations.destroy', [$firstBannerId, $translation->id]) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
