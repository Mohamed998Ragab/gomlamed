        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Second Banner Translation</h4>
                            <a class="btn btn-block btn-primary"
                                style="max-width:150px; float:right; display:inline-block;"
                                href="{{ route('secondBanners.translations.create', [$secondBannerId]) }}">Add Banner Data
                            </a>
                            <br> <br>
                            <br>
                            <a class="btn btn-block btn-primary"
                            style="max-width:100px; float:right; display:inline-block;"
                            href="{{ url('admin/secondBanner') }}">Back
                            </a>
                                ...
                                <table id="" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('secondBanners.translations.edit', [$secondBannerId, $translation->id]) }}" class="btn  btn-primary">Edit</a>
                                                <form action="{{ route('secondBanners.translations.destroy', [$secondBannerId, $translation->id]) }}" method="POST" style="display:inline;">
                                                    @csrf
                                                    @method('DELETE')
